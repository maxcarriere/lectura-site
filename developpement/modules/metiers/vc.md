...
- **[VC ZeroShot]({{ '/developpement/modules/metiers/vc-zeroshot/' | relative_url }})** (`lectura-vc-zeroshot`, ~126 Mo) : OpenVoice v2 — conversion vers n'importe quelle voix via un extrait de reference ou un preset, avec blend de voix et decalage de formants
- **[VC Locuteurs]({{ '/developpement/modules/metiers/vc-locuteurs/' | relative_url }})** (`lectura-vc-locuteurs`, ~1.4 Go) : RVC — conversion vers 6 voix francaises pre-entrainees
...
| [`lectura-vc-locuteurs`]({{ '/developpement/modules/metiers/vc-locuteurs/' | relative_url }}) | ~1.4 Go | RVC, 6 voix pre-entrainees |
