...
Première version stabilisée, qui constitue un socle solide pour des enrichissements futurs — un projet qui gagnerait à être poursuivi et approfondi. Le tout accessible via un module Python avec 18 méthodes de requêtage.
