...
<div class="home-grid">
  ...
  <div class="home-card">
    <h2>Services</h2>
    <p>Integration logicielle, histoires syllabiques sur commande, enrichissement de texte.</p>
    <a class="more-link" href="{{ '/solutions/services/' | relative_url }}">Decouvrir</a>
  </div>
</div>
